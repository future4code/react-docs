    ...
    render() {
        return (
            <div>
                ...
                <p>As props são somente para consulta, ou seja, nõa podemos alterar a props dentro do componente `Welcome` nesse caso.</p>
            </div>
        )
    }
}
...
// Componentes de classe sempre extendem a classe React.Component
